...
class MyDataset(Dataset):
    def __init__(self, df, src_tokenizer, tgt_tokenizer, max_src_length, max_target_length,):
        self.df = df
...
def prepare_model(src_tokenizer, tgt_tokenizer, max_src_len, max_tgt_len, num_encoder_hidden_layers, num_decoder_hidden_layers, encoder_ckpt_dir, model_ckpt_dir=None):
    config_encoder = LiltConfig.from_pretrained(encoder_ckpt_dir, max_position_embeddings=max_src_len+2, num_hidden_layers=num_encoder_hidden_layers)
